...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("BCA S1");
        divisions.add("BCA S2");
        divisions.add("BCA S3");
        divisions.add("BCA S4");
        divisions.add("BCA S5");
    ...
    public void loadSettings(MenuItem item) {
        Intent launchIntent = new Intent(this,SettingActivity.class);
