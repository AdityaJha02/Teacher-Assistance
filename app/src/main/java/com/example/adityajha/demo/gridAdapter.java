...
public class gridAdapter extends BaseAdapter{
    ...
    public static class createRequest extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final Spinner hour = (Spinner) v.findViewById(R.id.periodID);
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext(),"default"  )
